...
if ($is_localhost) {
    $base_url = $protocol . "://" . $host . "/ver2";
} else {
    if ($is_ver2) {
        $base_url = "https://www.clickvedicastro.com/ver2";
    } else {
...
if (!defined('ROOT_PATH')) {
    define("ROOT_PATH", $_SERVER['DOCUMENT_ROOT'] . ($is_localhost ? "/ver2" : ""));
}
?>
...
<head>
 ...
 <meta name="description" content="<?php echo isset($meta_description) ? $meta_description : 'ClickVedicAstro: AI-powered free birth chart reports,Online Vedic astrology services, daily horoscope, marriage matching & predictions in Indian languages'; ?>">
  ...
  <meta property="og:url" content="<?php echo isset($meta_url) ? $meta_url : 'https://www.clickvedicastro.com/ver2/'; ?>" />
  ...
  <meta name="google-adsense-account" content="ca-pub-5004450060607590">
	...
	<script type="application/ld+json">
	{
	  ...
	  "@type": "WebSite",
	  "name": "ClickVedicAstro",
	  "url": "https://www.clickvedicastro.com",
	  "potentialAction": {
		"@type": "SearchAction",
		"target": "https://www.clickvedicastro.com/?s={search_term_string}",
...
<body>
<!-- info section -->
  <!--div class="info-top fade show p-2" role="alert">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <div class="d-flex align-items-center justify-content-center p-0 mb-0 top-menu">
           <p class="mb-0 font-small"><strong>Popular Services:</strong>
             <ul class="menu-list">
                <li><a href="hindu-temples.php" class="dropdown-item">Temples</a></li>
                <li><a href="numerology.php" class="dropdown-item">Numerology</a></li>
                <li><a href="vastu-shastra.php" class="dropdown-item">Vastu Shastra</a></li>
                <li><a href="birth-stones.php" class="dropdown-item">Birth Stones</a></li>    
                <li><a href="poojas-manthras.php" class="dropdown-item">Pooja/Manthras</a></li>
                <li><a href="homas.php" class="dropdown-item">Homas</a></li>
                <li><a href="festivals.php" class="dropdown-item">Festivals</a></li>
                <li><a href="childrens-names.php" class="dropdown-item">Childrens Names</a></li> 
                <li><a href="yoga.php" class="dropdown-item">Yoga</a></li>
              </ul>
           </p>
          </div>
        </div>
